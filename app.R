setwd("/Users/boo/ShinyPractice/Danya")
library(shiny)
library(pracma)
...
server <- function(input, output, session) {
  ...
  output$eqCO2Plot <- renderPlot ({
    ...
    plot(c(1880, 2300), c(-.7, 7.7), type = "l", col = "white", main = "Predicted Global Surface Temperature Fluctations", xlab = "Year", ylab = "GMST (°C)")
    
    lines(futureTime[126:421], GMST2_26[126:421], col = "blue")
    lines(futureTime[126:421], GMSTeq_45[126:421], col = "pink")
    lines(futureTime[126:421], GMSTeq_6[126:421], col = "green")
    lines(futureTime[126:421], GMSTeq_85[126:421], col = "orange")
    
    switch(input$Pathways,
      "2.6 Pathway" = lines(futureTime[126:421], GMST2_26[126:421], col = "blue", lwd = 5),
      "4.5 Pathway" = lines(futureTime[126:421], GMSTeq_45[126:421], col = "pink", lwd = 5),
      "6.0 Pathway" = lines(futureTime[126:421], GMSTeq_6[126:421], col = "green", lwd = 5),
      "8.5 Pathway" = lines(futureTime[126:421], GMSTeq_85[126:421], col = "orange", lwd = 5)
    )
  ...
  output$pathwayExplain <- renderText({
    switch(input$Pathways,
        "2.6 Pathway" = paste("Things aren't that bad...look at that line stabilize"),
        "4.5 Pathway" = paste("Alright well things are getting worse already. This is probably where we're at"),
        "6.0 Pathway" = paste("YIKES LET'S NOT DO THIS"),
        "8.5 Pathway" = paste("THINGS HAVE ESCALATED VERY QUICKLY.")
    )
  })
}
